...
{
	// OTAA Device EUI MSB
	uint8_t node_device_eui[8] = {0x60, 0x81, 0xF9, 0x3F, 0xBE, 0x6E, 0x76, 0xC2};
	// OTAA Application EUI MSB
	uint8_t node_app_eui[8] = {0x60, 0x81, 0xF9, 0x8D, 0xE1, 0xDC, 0x13, 0x31};
	// OTAA Application Key MSB
	uint8_t node_app_key[16] = {0x37, 0x46, 0x84, 0x4E, 0x83, 0xD6, 0x0F, 0x47, 0x8D, 0x8B, 0x3D, 0x55, 0x6E, 0x68, 0x4E, 0x3D};
};

struct s_lorawan_settings
{
	// Send repeat time in seconds 
	uint32_t send_repeat_time = 1;
